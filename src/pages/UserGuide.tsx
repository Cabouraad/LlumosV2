              ...
              <div>
                ...
                <div className="mt-4 p-4 bg-primary/5 rounded-lg border border-primary/20">
                  <p className="text-sm text-muted-foreground">
                    <strong>Tip:</strong> You can customize the types of prompts generated by adding or removing keywords in your Business Context. The AI uses your keywords to create relevant suggestions that match your specific needs.
                  </p>
                </div>
              </div>
