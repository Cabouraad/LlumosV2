-- Create a secure admin function that only allows specific email access
-- This uses SECURITY DEFINER to check the email server-side

CREATE OR REPLACE FUNCTION get_super_admin_dashboard()
RETURNS TABLE (
  org_id uuid,
  org_name text,
  org_domain text,
