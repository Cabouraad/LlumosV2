...
serve(async (req) => {
  ...
  try {
    ...
    const pdfBytes = await generatePDF(firstName, domain, overallScore, allResults, businessContext, categoryVisibility, shareOfVoice, refinedCompetitorCandidates, aiOpportunity, classifiedCompetitors, scoreBreakdown, validatedEntityTrace);
